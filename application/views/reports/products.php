<div class="d-flex justify-content-between align-items-center mb-3">
	<h1 class="page-title">Laporan Per Produk</h1><br>
	<a href="<?= site_url('reports/export_pdf?type=products&start_date='.$start_date.'&end_date='.$end_date) ?>" class="btn btn-danger"><i class="align-middle" data-feather="file-text"></i> Export PDF</a>
</div>
	...
	<div class="card-body">
		<form class="row mb-3" method="get">
			...
			<div class="col-md-4 d-flex align-items-end">
				...
				<a href="<?= site_url('reports/products') ?>" class="btn btn-secondary ms-2">Reset</a>
			</div>
		</form>
